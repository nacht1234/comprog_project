...
def play_sub_menu():
    while True:
        ...
        shapes_only_button = Button(image=None, pos=(640, 400), text_input="Shapes Only", font=get_font(30), base_color="Black", hovering_color="Gray")
        shapes_with_colors_button = Button(image=None, pos=(640, 460), text_input="Shapes with Colors", font=get_font(30), base_color="Black", hovering_color=("Green"))
